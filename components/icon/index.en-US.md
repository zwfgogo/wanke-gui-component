...
```jsx
import { StarOutlined, StarFilled, StarTwoTone } from 'wanke-icon/lib/icons';
...
```jsx
import { MessageOutlined } from 'wanke-icon/lib/icons';
...
```jsx
import { getTwoToneColor, setTwoToneColor } from 'wanke-icon/lib/icons';
...
```js
import { createFromIconfontCN } from 'wanke-icon/lib/icons';
...
```jsx
import Icon from 'wanke-icon/lib/icons';
