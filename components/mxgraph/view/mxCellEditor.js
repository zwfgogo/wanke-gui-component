      ...
      if (!this.autoSize || (state.style[mxConstants.STYLE_OVERFLOW] == 'fill')) {
        ...
        if (isEdge) {
          ...
          if (!state.view.graph.cellRenderer.legacySpacing || state.style[mxConstants.STYLE_OVERFLOW] != 'width') {
            ...
            var spacingTop = (parseInt(state.style[mxConstants.STYLE_SPACING_TOP] || 0) + mxText.baseSpacingTop) * scale + spacing
            var spacingRight = (parseInt(state.style[mxConstants.STYLE_SPACING_RIGHT] || 0) + mxText.baseSpacingRight) * scale + spacing
            var spacingBottom = (parseInt(state.style[mxConstants.STYLE_SPACING_BOTTOM] || 0) + mxText.baseSpacingBottom) * scale + spacing
            var spacingLeft = (parseInt(state.style[mxConstants.STYLE_SPACING_LEFT] || 0) + mxText.baseSpacingLeft) * scale + spacing
