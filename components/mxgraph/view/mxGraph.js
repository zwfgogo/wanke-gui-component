...
class mxGraph extends mxEventSource {
   ...
   */
  collapsedImage = new mxImage(require('../images/collapsed.gif'), 9, 9)
   ...
   */
  expandedImage = new mxImage(require('../images/expanded.gif'), 9, 9)
  ...
  selectAll(parent, descendants) {
    ...
    var cells = (descendants) ? this.model.filterDescendants(cell => {
