    ...
    class Graph1 extends mxGraph {
      graphModelChanged(changes) {
        if (!this.suspended && this.outline != null) {
          super.graphModelChanged(changes)
        }
      }
    }

    var graph = new Graph1(container, this.source.getModel(), this.graphRenderHint, this.source.getStylesheet())
