...
class mxXmlCanvas2D extends mxAbstractCanvas2D {
  ...
  setStrokeAlpha(value) {
    if (this.compressed) {
      ...
      super.setStrokeAlpha(...arguments)
    }
  ...
  setStrokeColor(value) {
    ...
    if (this.compressed) {
      ...
      super.setStrokeColor(...arguments)
    }
  ...
  setStrokeWidth(value) {
    if (this.compressed) {
      ...
      super.setStrokeWidth(...arguments)
    }
  ...
  setDashPattern(value) {
    if (this.compressed) {
      ...
      super.setDashPattern(...arguments)
    }
  ...
  setFontBackgroundColor(value) {
    if (this.textEnabled) {
      ...
      if (this.compressed) {
        ...
        super.setFontBackgroundColor(...arguments)
      }
  ...
  setFontBorderColor(value) {
    if (this.textEnabled) {
      ...
      if (this.compressed) {
        ...
        super.setFontBorderColor(...arguments)
      }
  ...
  setShadowColor(value) {
    if (this.compressed) {
      ...
      super.setShadowColor(...arguments)
    }
  ...
  setShadowAlpha(value) {
    if (this.compressed) {
      ...
      super.setShadowAlpha(...arguments)
    }
  ...
  setShadowOffset(dx, dy) {
    if (this.compressed) {
      ...
      super.setShadowOffset(...arguments)
    }
